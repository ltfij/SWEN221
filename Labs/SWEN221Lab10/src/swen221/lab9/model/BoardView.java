...
/**
 * Implements a view of the board, from which it is impossible to actually change the board. This
 * view can be passed to rules so they can "see" the board, but not change it.
 * 
