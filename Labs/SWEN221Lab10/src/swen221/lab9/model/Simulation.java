...
/**
 * Implements an abstract version of Conway's game of life where the rules for birth's and deaths
 * are customisable. The simulation operators over a given board using a given set of rules. The
 * simulation "executes" the game one step at a time.
 * 
...
public class Simulation {
    ...
    /**
     * Take a single step of the simulation. This is done by walking through each cell and
     * calculating its new state by applying the rules in their order until either one applies and
     * yields a new state, or not apply (hence, the original state is retained).
     */
    public void step() {
    ...
    /**
     * Take N steps through the simulation. This is done by performing N single steps.
     * 
     * @param n
