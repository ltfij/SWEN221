...
/**
 * <p>
 * Implements a two dimensional grid of cell "states", ranging from 0 up to (and including) 9. In
 * Conway's original Game of Life, only two states are needed: alive and dead. However, for more
 * complicated variations on the game we can have more game states to represent qualities, such as
 * "health" or "happiness", etc.
 * </p>
 * 
...
public class Board implements BoardView {
    ...
    /**
     * Construct an empty game board of a given dimension where each cell is in state 0.
     * 
     * @param width
    ...
    public Board(int width, int height) {
        ...
        this.width = width;
        this.height = height;
        Arrays.fill(cells, 9);  // XXX 9 or 0?
    }
